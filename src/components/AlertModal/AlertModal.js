...
const { WarningCircleIcon, CheckCircleIcon } = Icons;

const AlertModal = ({ message, onClose, type = 'WARNING' }) => {
  const className = 'mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200';
  const IconTypes = {
